...
public class SecurityExceptionHandler {
    ...
    @ExceptionHandler(SecurityConfigStateException.class)
    public ResponseEntity<Problem> handleSecurityConfigStateException(SecurityConfigStateException securityConfigStateException) {
        Problem zalandoProblem = new Problem();
        zalandoProblem.setDetail(securityConfigStateException.getMessage());
        zalandoProblem.setTitle(HttpStatus.BAD_REQUEST.getReasonPhrase());
        zalandoProblem.setStatus(HttpStatus.BAD_REQUEST.value());
